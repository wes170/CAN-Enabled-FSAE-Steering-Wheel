...
mistakes — thirty-six of them, found so far (lesson L19 in `engineering-rigor.md`), several of which
...
someone who didn't write it. This project's own defect history backs that up directly: thirty-six
